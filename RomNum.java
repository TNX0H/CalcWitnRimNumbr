public enum RomNum {
    ...
    XVI("VI",16),XVII("XVII",17),XVIII("XVIII",18), XIX("XIX",19),XX("XX",20),
    ...
    LXXXI("LXXXII",81),LXXXII("LXXXII",82),LXXXIII("LXXXIII",83),LXXXIV("LXXXIV",84),LXXXV("LXXXV",85),
    LXXXVI("LXXXVI",86),LXXXVII("LXXXVII",87),LXXXVIII("LXXXVIII",88), LXXXIX("LXXXIX",89),XC("XC",90),
    XCI("XC",91),XCII("XCII",92),XCIII("XCIII",93),XCIV("XCIV",94),XCV("XCV",95),
